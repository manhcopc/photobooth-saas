      ...
      <div>
        ...
        {sessionId && (
          <div className="mt-6 flex flex-col items-center">
            <p className="text-sm font-bold text-slate-600 mb-2">Quét mã để tải về điện thoại</p>
            ...
            <a href={shareUrl} target="_blank" rel="noopener noreferrer" className="mt-2 text-xs font-semibold text-purple-600 underline">Hoặc bấm vào đây để mở</a>
          </div>
        )}
