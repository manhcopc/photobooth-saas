...
const normalizeFrame = (frame) => {
  ...
  return {
    ...
    preferredCameraFacing: frame.preferred_camera_facing || frame.preferredCameraFacing || 'user',
    preferred_camera_facing: frame.preferred_camera_facing || frame.preferredCameraFacing || 'user',
    preferredOrientation: frame.preferred_orientation || frame.preferredOrientation || 'portrait',
    preferred_orientation: frame.preferred_orientation || frame.preferredOrientation || 'portrait',
...
const toPayload = (payload) => {
  ...
  return {
    ...
    render_mode: renderMode,
    preferred_camera_facing: payload.preferredCameraFacing || payload.preferred_camera_facing || 'user',
    preferred_orientation: payload.preferredOrientation || payload.preferred_orientation || 'portrait',
...
export const getLegacyFrame = (event) => {
  ...
  preferredCameraFacing: 'user',
  preferred_camera_facing: 'user',
